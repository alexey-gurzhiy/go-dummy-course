...
// Среды выбранных приложений обязательно должно быть хотя бы одно, в котором реализовано два разных варианта одного и того же алгоритма (например, в задаче на сортировку слайсов). Для таких приложений добавьте бенчмарки.
...
import (
	Sort "Lesson10/Sort"
	// Calc "Lesson10/Calc"
	// Fibbonachi "Lesson10/Fibbonachi"
)

func main() {
	// Calc.Run(-5.3, 3, "V")
	// println()
	// Fibbonachi.RunOrig(45)
	// println()
	// Fibbonachi.RunOptimized1(45)
	// println()
	// Fibbonachi.RunOptimized2(45)
	// println()
	// Fibbonachi.RunOptimized3(45)
	println()
	Sort.StartSort(45, 45)
} 
